...
def compare(left, right):
    return -1 if compare_left_right(left, right) else 1
...
if __name__ == '__main__':
    ...
    content_parsed_part_2 = [e for lst in deepcopy(content_parsed) for e in lst]
    content_parsed_part_2.append([[2]])
    content_parsed_part_2.append([[6]])
